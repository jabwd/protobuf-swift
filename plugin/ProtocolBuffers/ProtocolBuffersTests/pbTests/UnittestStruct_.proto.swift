...
public struct UnitTestStruct {
//Protobuf
  fileprivate var memoizedSerializedSize:Int32 = -1
  public var unknownFields:UnknownFieldSet = UnknownFieldSet(fields: [:])

//
  public fileprivate(set) var testStr:String = ""

  public private(set) var hasTestStr:Bool = false
  public private(set) var testInt:Int32 = Int32(0)

  public private(set) var hasTestInt:Bool = false
  ...
  public func writeTo(codedOutputStream:CodedOutputStream) throws {
    ...
    // private size check
  private mutating func serializedSize() -> Int32 {
  ...
  public static func getBuilder() -> UnitTestStruct {
    return UnitTestStruct.classBuilder() as! UnitTestStruct
  }
  public func getBuilder() -> UnitTestStruct {
    return classBuilder() as! UnitTestStruct
  }
  public func toBuilder() throws -> UnitTestStruct {
    return try UnitTestStruct.builderWithPrototype(prototype: self)
  }
  public static func builderWithPrototype(prototype:UnitTestStruct) throws -> UnitTestStruct {
    return try UnitTestStruct().mergeFrom(other: prototype)
  }
...
////         }
////    }
////    public func setTestInt(_ value:Int32) -> UnitTestStruct {
////      self.testInt = value
////      return self
////    }
////    public func clearTestInt() -> UnitTestStruct{
...
//         }
//    }
//    public override func clear() -> UnitTestStruct {
...
//      return returnMe
//    }
    public func mergeFrom(other:UnitTestStruct) throws -> UnitTestStruct {
...
extension UnitTestStruct: GeneratedMessageProtocol {
  public static func parseArrayDelimitedFrom(inputStream:InputStream) throws -> Array<UnitTestStruct> {
  ...
  public static func parseDelimitedFrom(inputStream:InputStream) throws -> UnitTestStruct? {
    return try UnitTestStruct().mergeDelimitedFrom(inputStream:inputStream)?.build()
  }
